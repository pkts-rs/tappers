...
extern "C" {
    ...
    fn WintunCreateAdapter(name: PCWSTR, tunnel_type:  PCWSTR, requested_guid: GUID) -> *mut WintunAdapter;
...
impl Wintun {
    ...
    pub fn create_adapter(&self, name: &[u16], tunnel_type: &[u16], requested_guid: GUID) -> io::Result<NonNull<WintunAdapter>> {
        ...
        let handle = unsafe { WintunCreateAdapter(name.as_ptr(), tunnel_type.as_ptr(), requested_guid) };
